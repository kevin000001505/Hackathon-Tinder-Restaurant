<template>
    <div>
        ...
        <div class="flex left-0 fixed bottom-8 w-screen">
            <div class="w-1/3"></div>
            <div class="xl3:w-1/3">
                    <div class="flex items-center gap-x-[5vw]">
                    ...
                    <Button raised rounded @click="drawer = true"><span class="material-icons">undo</span></Button>
                </div>
            </div>
            <div class="w-1/3"></div>
        </div>
